...
"steps_es":["Revisa primero que tu pasaporte sea válido.","Confirma qué tipo de visa corresponde a tu viaje.","Ten a mano los datos exactamente como aparecen en tu pasaporte.","Abre el formulario oficial de eVisa Cuba.","Escribe tus datos con cuidado y revisa todo antes de enviar.","Conserva la información de tu visa para el viaje."],
"steps_en":["First check that your passport is valid.","Confirm which visa applies to your trip.","Have your information exactly as shown on your passport.","Open the official Cuba eVisa form.","Enter your information carefully and review it before submitting.","Keep your visa information for your trip."],
...
"steps_es":["Entra al sitio oficial de D'Viajeros.","Selecciona el idioma que prefieras.","Completa tus datos personales exactamente como aparecen en tus documentos.","Completa la información de tu viaje y vuelo.","Revisa cuidadosamente todos los datos antes de finalizar.","Al terminar, conserva el comprobante y el código QR para presentarlo cuando corresponda."],
"steps_en":["Open the official D'Viajeros website.","Select your preferred language.","Enter your personal information exactly as shown on your documents.","Enter your trip and flight information.","Carefully review everything before finishing.","When completed, keep your confirmation and QR code for your trip."],
...
FLIGHTS={
"google":{"name":"Google Flights","description_es":"Busca vuelos y compara opciones de diferentes aerolíneas.","description_en":"Search flights and compare options from different airlines.","url":OFFICIAL},
"american":{"name":"American Airlines","description_es":"Consulta vuelos de American hacia Cuba.","description_en":"Check American Airlines flights to Cuba.","url":OFFICIAL},
"charters":{"name_es":"Charters a Cuba","name_en":"Charter flights to Cuba","description_es":"Consulta opciones de vuelos charter y verifica disponibilidad, fechas y precios directamente con el proveedor.","description_en":"Check charter flight options and verify availability, dates and prices directly with the provider.","url":OFFICIAL}
}
...
@app.get("/health")
def health():
return {"status":"ok","app":"CUBA AUTO TRAVEL 2026","version":"1.0.0"}

@app.get("/api")
def api_info():
return {"name":"CUBA AUTO TRAVEL 2026","status":"ok","version":"1.0.0","access":"free","endpoints":["/api/data","/api/visa","/api/visa/check","/api/dviajeros","/api/dviajeros/check","/api/passports","/api/passports/check","/api/guides","/api/flights","/api/airports","/api/destinations","/api/charters","/api/official"]}
...
return {"status":"ok","request":request.model_dump(),"data":CUBA_VISA}
...
return {"status":"ok","request":request.model_dump(),"data":D_VIAJEROS}
...
return {"status":"ok","request":request.model_dump(),"data":PASSPORTS}
